...
def main():
    ...
    parser.add_argument('-keep_heads', type=int, default=6,
    ...
    parser.add_argument('-emb_hidden_dim', type=int, default=384,
    ...
    importance_dir = os.path.join(args.model_path, 'temp', 'taylor.pkl')
